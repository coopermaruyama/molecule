 ...
 */
var CallToAction = function(data) {
  return {
    name: data.name,
    title: data.title,
...
if (Meteor.isClient) {
  Template.CallToAction.viewmodel(
    function(data) { return data.name && data.name || 'CallToAction'; }, // name
    CallToAction, // ViewModel
    ['shouldGroupButtons', 'buttons'] // helper
  );
}

/*==========  Export  ==========*/
Molecule.CallToAction = CallToAction;
